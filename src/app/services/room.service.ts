  ...
  private roomsSub = new BehaviorSubject<any[]>([
    {
      ...
      type: 'Individual',
      floor: 'Primera',
      description: 'Cama individual, baño privado y WiFi gratis.',
      extras: ['WiFi'],
      oldPrice: '79 €',
      price: '47 €',
      reviews: [
    ...
    },
    {
      ...
      type: 'Doble',
      floor: 'Segunda',
      description: 'Habitación doble con desayuno opcional y vistas.',
    ...
    },
    {
      ...
      type: 'Suite',
      floor: 'Tercera',
      description: 'Suite amplia para familias, con terraza y servicios incluidos.',
